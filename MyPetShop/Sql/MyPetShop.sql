...
ON 
( NAME = MyPetShop,
    FILENAME = 'F:\Book\MyPetShop\App_Data\MyPetShop.mdf',
    SIZE = 5MB,
    MAXSIZE = 50MB,
    FILEGROWTH = 1MB )
LOG ON
( NAME = MyPetShop_log,
    FILENAME = 'F:\Book\MyPetShop\App_Data\MyPetShop_log.ldf',
    SIZE = 3MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 1MB )
...
GO
USE MyPetShop
/*分别建立Category、Supplier、Product、Order和OrderItem等数据表的结构*/
