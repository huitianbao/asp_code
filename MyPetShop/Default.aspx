...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
  <asp:UpdatePanel ID="upWeather" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
      <asp:WebPartZone ID="zwpWeather" runat="server" Width="100%" HeaderText="天气预报" WebPartVerbRenderMode="TitleBar">
        <ZoneTemplate>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="Server">
  <asp:WebPartZone ID="zwpAutoShow" runat="server" Width="520px" HeaderText="热销商品" WebPartVerbRenderMode="TitleBar">
    <ZoneTemplate>
