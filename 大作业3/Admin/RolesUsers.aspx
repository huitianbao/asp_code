...
&nbsp;</td>
    ...
    <div>
        ...
        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvUsers_RowDeleting" HorizontalAlign="Center" Height="321px" Width="371px">
            <Columns>
