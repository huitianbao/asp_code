<%@ Page Language="C#" AutoEventWireup="true" CodeFile="denglu.aspx.cs" Inherits="首页_denglu" %>
    ...
    <div>
        ...
        <div class="auto-style1">
            ...
            <table class="auto-style2">
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
                    <td>&nbsp;&nbsp;&nbsp; <asp:Login ID="Login1" runat="server" DestinationPageUrl="~/数据库2/DataManage.aspx">
        </asp:Login>
