    ...
    <div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style8" style="text-align: right">&nbsp;角色：<asp:ListBox ID="lstRoles" runat="server" AutoPostBack="True"></asp:ListBox>
                    </td>
                    <td class="auto-style7">用户：<asp:ListBox ID="lstUsers" runat="server" SelectionMode="Multiple"></asp:ListBox>
                    </td>
                    <td>
        ...
        <asp:GridView ID="gvUsers" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvUsers_RowDeleting" HorizontalAlign="Center">
            <Columns>
