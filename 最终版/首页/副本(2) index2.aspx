<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本(2) index2.aspx.cs" Inherits="首页_index2" %>
...
<body style="text-align: center">
    <form id="form2" runat="server">
            ...
            <tr>
                ...
                <td class="auto-style10">
                    <asp:HyperLink ID="HyperLink1" runat="server" Height="52px" NavigateUrl="~/首页/denglu.aspx" Width="50px">登陆</asp:HyperLink>
                    <asp:LoginView ID="logHeader" runat="server">
                        <AnonymousTemplate>
                            您还未登录
                        </AnonymousTemplate>
                        <RoleGroups>
                            <asp:RoleGroup Roles="Admin">
                                <ContentTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkbtnPwd" runat="server">密码修改</asp:LinkButton>
                                    <asp:LinkButton ID="lnkbtnUserManage" runat="server" PostBackUrl="~/Admin/RoleUsers.aspx">用户管理</asp:LinkButton>
                                </ContentTemplate>
                            </asp:RoleGroup>
