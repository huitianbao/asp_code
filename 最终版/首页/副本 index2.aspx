        ...
        >
            ...
            <StaticSelectedStyle BackColor="#1C5E55" />
                ...
                <table class="auto-style11">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" Height="279px" TextMode="MultiLine" Width="606px" OnTextChanged="TextBox1_TextChanged" style="margin-top: 0px" >普通外科团队参加2017年中华医学会肠外肠内营养学年会
...
2017-05-312017北京医院甲状腺外科研讨会召开暨北京医师协会甲状腺疾病专委会成立
                        ...
                        <td class="auto-style13">
                                ...
                                <asp:Image ID="Image5" runat="server" ImageUrl="~/image/医生.jpg" Width="468px" Height="317px" ImageAlign="Left" style="margin-top: 11px" />
                                <br />
                    ...
                    <tr>
                        ...
                        <td class="auto-style15">
                            <asp:Image ID="Image6" runat="server" Height="318px" ImageUrl="~/image/室内0.jpg" Width="615px" />
                        </td>
                        <td class="auto-style13">
                            <asp:Image ID="Image7" runat="server" Height="320px" ImageUrl="~/image/室内1.jpg" Width="471px" ImageAlign="Left" />
                        </td>
                    </tr>
                </table>
